...
export const DEFAULT_MAINTENANCE_TYPES = [
  { nome: 'Troca de Óleo', descricao: 'Troca de óleo do motor', intervalo_km: 10000 },
  { nome: 'Filtro de Ar', descricao: 'Troca do filtro de ar', intervalo_km: 15000 },
  { nome: 'Filtro de Combustível', descricao: 'Troca do filtro de combustível', intervalo_km: 20000 },
  { nome: 'Pastilhas de Freio', descricao: 'Troca das pastilhas de freio', intervalo_km: 30000 },
  { nome: 'Pneus', descricao: 'Troca ou rodízio de pneus', intervalo_km: 40000 },
  { nome: 'Correia Dentada', descricao: 'Troca da correia dentada', intervalo_km: 60000 },
  { nome: 'Revisão Geral', descricao: 'Revisão completa do veículo', intervalo_km: 20000 },
] as const;
