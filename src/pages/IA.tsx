    ...
    try {
      ...
      if (!data.valid) {
        toast({
          ...
          description: data.error || "Por favor, verifique sua chave API OpenAI.",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        title: "Sucesso",
        description: "Chave API validada e configuração salva com sucesso!",
      });
    } catch (error) {
      console.error('Erro ao validar API key:', error);
      toast({
        title: "Erro de validação",
        description: "Não foi possível validar a chave API. Tente novamente.",
        variant: "destructive",
      });
    } finally {
    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="flex items-center space-x-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-200">Inteligência Artificial</h1>
            <p className="text-gray-600 dark:text-gray-400">Analise automaticamente seus comprovantes e cupons fiscais</p>
          </div>
        </div>
          ...
          <TabsContent value="config" className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-200">Configurações OpenAI</h2>
              </div>
          ...
          <TabsContent value="upload" className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-200">Upload de Comprovantes</h2>
              </div>
            ...
            {analysisResults.length > 0 && (
              <Card className="p-6">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-200 mb-4">Resultados da Análise OpenAI</h3>
                <div className="space-y-4">
            ...
            <Card className="p-6">
              ...
              {analysisResults.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Nenhuma análise realizada ainda</p>
                </div>
              ) : (
