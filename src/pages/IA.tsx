    ...
    try {
      ...
      if (!data.valid) {
        toast({
          ...
          description:
            data.error || "Por favor, verifique sua chave API OpenAI.",
          variant: "destructive",
        });
        return;
      }
  ...
  const handleApproveResult = async (result: AnalysisResult) => {
    try {
      ...
      toast({
        title: "Sucesso",
        description: `${
          result.tipo === "despesa" ? "Despesa" : "Receita"
        } criada com sucesso!`,
      });
    } catch (error) {
      ...
      toast({
        title: "Erro",
        description:
          "Erro ao criar transação. Verifique se uma categoria foi selecionada.",
        variant: "destructive",
      });
    }
  };
        ...
        <div className="flex items-center space-x-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Analise automaticamente seus comprovantes e cupons fiscais
            </p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Sua chave API será armazenada com segurança no banco de
                    dados
                  </p>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-yellow-800">
                      Configure sua chave API OpenAI na aba Configurações antes
                      de fazer upload.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  >
                    {isAnalyzing
                      ...
                      : `Analisar ${uploadedFiles.length} arquivo(s) com IA`}
                  </Button>
                </div>
              )}
            </Card>
                        ...
                        <div>
                          ...
                          {result.status === "pending" ? (
                            <Select
                              ...
                              onValueChange={(value) =>
                                handleCategoryChange(result.id, value)
                              }
                            >
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Esta ação não pode ser desfeita. O resultado
                                  da análise será excluído permanentemente.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                <AlertDialogAction
                                  onClick={() => excluirResultado(result.id)}
                                >
                                  Excluir
                                </AlertDialogAction>
                              </AlertDialogFooter>
