    ...
    <Card className="fixed bottom-4 right-4 z-50 w-80 max-h-96 overflow-y-auto bg-white dark:bg-gray-800 shadow-lg border-2">
      ...
      <CardContent className="space-y-3 text-xs">
        ...
        <div className="flex items-center justify-between">
          <span>Status:</span>
          <Badge
            variant={themeInfo?.hasThemeConflict ? "destructive" : "default"}
          >
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-between">
            <span>Sistema:</span>
            <Badge variant="outline">{themeInfo?.systemTheme}</Badge>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <Badge
              variant={
                themeInfo?.appliedTheme === "nenhum" ? "destructive" : "default"
              }
            >
        ...
        {themeInfo && themeInfo.invisibleElements > 0 && (
          <div className="flex justify-between">
            ...
            <Badge variant="destructive">{themeInfo.invisibleElements}</Badge>
          </div>
        )}
