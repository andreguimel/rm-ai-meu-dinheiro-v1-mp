...
(function() {
    ...
    function log(type, message, data = null) {
        ...
        console.log(`[iPhone Cache Cleaner ${type.toUpperCase()}] ${message}`, data || '');
    }
        ...
        if ('serviceWorker' in navigator) {
            try {
                ...
                if (registrations.length > 0) {
                    log('info', `Encontrados ${registrations.length} service workers, desregistrando...`);
            ...
            try {
                ...
                if (indexedDB.databases) {
                    ...
                    if (databases.length > 0) {
                        log('info', `Encontrados ${databases.length} IndexedDB, limpando...`);
    ...
    if (shouldCleanCache()) {
        log('info', 'Problemas de cache detectados, executando limpeza automática...');
        performFullCleanup();
    } else {
