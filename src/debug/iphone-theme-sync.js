...
(function() {
    ...
    function checkInvisibleElements() {
        ...
        if (invisibleElements.length > 0) {
            console.warn('⚠️ Elementos potencialmente invisíveis encontrados:', invisibleElements.length);
    ...
    console.log('🎨 iPhone Theme Sync carregado - Use window.iPhoneThemeDebug para debug');
