...
(function() {
    ...
    let reloadAttempts = parseInt(sessionStorage.getItem('iphone-reload-attempts') || '0');
    ...
    function log(type, message, data = null) {
        ...
        console.log(`[iPhone Fallback ${type.toUpperCase()}] ${message}`, data || '');
    }
    ...
    function reloadPage() {
        ...
        log('info', `Recarregando página (tentativa ${reloadAttempts}/${config.maxReloadAttempts})`);
