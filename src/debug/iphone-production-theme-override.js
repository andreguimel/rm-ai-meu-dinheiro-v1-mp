...
(function () {
  ...
  console.log(
    "[iPhone Theme Override] Iniciando override de tema para produção"
  );
  ...
  function forceCorrectTheme() {
    try {
      ...
      document.body.style.backgroundColor =
        systemTheme === "dark" ? "hsl(222.2 84% 4.9%)" : "hsl(0 0% 100%)";
      document.body.style.color =
        systemTheme === "dark" ? "hsl(210 40% 98%)" : "hsl(222.2 84% 4.9%)";
      ...
      console.log(
        "[iPhone Theme Override] Tema aplicado com sucesso:",
        systemTheme
      );

      // Dispara evento customizado para notificar outros scripts
      window.dispatchEvent(
        new CustomEvent("iphone-theme-override", {
  ...
  window
    ...
    .addEventListener("change", (e) => {
      console.log(
        "[iPhone Theme Override] Mudança de tema do sistema detectada"
      );
  ...
  console.log(
    "[iPhone Theme Override] Override de tema inicializado com sucesso"
  );
})();
