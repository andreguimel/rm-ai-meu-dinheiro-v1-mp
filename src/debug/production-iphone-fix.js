...
(function () {
  ...
  console.log(
    "[Production iPhone Fix] Ambiente:",
  ...
  function fixThemeConflict() {
    ...
    try {
      ...
      if (storedTheme && storedTheme !== "system") {
        addProductionLog(
          "warn",
          "Tema armazenado problemático detectado:",
          storedTheme
        );
  ...
  function initProductionFix() {
    ...
    addProductionLog(
      "success",
      "Correções de produção inicializadas com sucesso"
    );
  }
  ...
  window
    ...
    .addEventListener("change", (e) => {
      addProductionLog(
        "info",
        "Mudança de tema do sistema detectada:",
